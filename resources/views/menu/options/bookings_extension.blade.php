                ...
                <a href="{{route('get_booking_detail', [$booking['trip_no'], $booking['driver_id']])}}">
                    <div class="row white">
                        ...
                        <div class="col-3 col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            ...
                            <p class="time rs-compl mw-100px {{($booking['status']==="cancelled")?'red':'green'}}">{{($booking['status']==="cancelled")?ucwords($booking['status']).' By '.ucwords($booking['cancel_by']):ucwords($booking['status'])}}</p>
                        </div>
